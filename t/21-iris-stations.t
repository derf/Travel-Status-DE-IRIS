...
is(
	scalar Travel::Status::DE::IRIS::Stations::get_station_by_location(
		7.02458, 51.43862, 1
	),
	1,
	'get_station_by_location(Foobar): only one match'
);
...
delta_ok(
	...
	0.127234298397033,
	'get_station_by_location(Foobar): correct distance'
);
