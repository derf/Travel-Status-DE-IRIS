...
my @stations = (
	...
	[ 'XAAH',  'Allerheiligenhöfe',      8100548 ],
	[ 'XNAO',  'Almelo',                  8400051 ],
	...
	[ 'XABA',  'Bad Aussee',  8100164 ],
	[ 'XABB',  'Bad Blumau',  8100663 ],
	[ 'XABG',  'Bad Gastein', 8100095 ],
	[ 'XABH', 'Bad Hofgastein', 8100097 ],
	[ 'XAIS', 'Bad Ischl',      8100157 ],
	[ 'XSRA', 'Bad Ragaz', 8509004, 9.505215797671367, 47.010306607675666 ],
	[ 'XASBW', 'Bad Schallerbach-Wallern', 8100021 ],
	[ 'XAVN',  'Bad Vigaun',               8101718 ],
	...
	[ 'XABI',  'Bichlbach-Berwang',     8100114 ],
	...
	[ 'XABD', 'Blindenmarkt', 8100669 ],
	[ 'XABL', 'Bludenz',      8100067 ],
	[ 'XABS', 'Böckstein',   8100094 ],
	[ 'XNBD', 'Bodegraven',   8400121 ],
	[ 'XSBOD', 'Bodio TI', 8505207, 8.906559054743022, 46.38025768143823 ],
	[ 'XFBN',  'Boen(F)',  8702850 ],
	[ 'XABC',  'Böheimkirchen',      8100661 ],
	...
	[ 'XABT', 'Brixen im Thale', 8100366 ],
	[ 'XABX', 'Brixlegg',        8100101 ],
	...
	[ 'XAFK', 'Feldkirch',  8100197 ],
	[ 'XAFT', 'Feldkirchen in Kärnten', 8100039 ],
	[ 'XAFX', 'Felixdorf',               8100780 ],
	[ 'XMBF', 'Budapest-Ferencváros',   5500133 ],
	[ 'XIFE', 'Ferrara',                 8300209 ],
	[ 'XAFB', 'Fieberbrunn',             8100053 ],
	...
	[ 'XAGE', 'Gerling im Pinzgau',   8100879 ],
	[ 'XEG',  'Girona',               7100077 ],
	...
	[ 'XAGR', 'Gramatneusiedl',        8100369 ],
	[ 'XEGR', 'Granollers',            7100075 ],
	[ 'XAGG', 'Gratwein-Gratkorn',     8100370 ],
	...
	[ 'XAGI',  'Gries im Pinzgau',       8100892 ],
	[ 'XAGP',  'Grieskirchen-Gallspach', 8100022 ],
	[ 'XAGM',  'Gröbming',              8100135 ],
	...
	[ 'XAHU', 'Hagenau im Innkreis', 8100914 ],
	[ 'XFHD', 'Hagondange',          8700283 ],
	[ 'XFHG', 'Haguenau',            8700347 ],
	[ 'XAHM', 'Haiming',             8100956 ],
	[ 'XAHT', 'Hall in Tirol',       8100105 ],
	[ 'XAHL', 'Hallein',             8100040 ],
	[ 'XAHE', 'Hallwang-Elixhausen', 8100929 ],
	...
	[ 'XAHP',  'Heiterwang-Plansee', 8100550 ],
	...
	[ 'XAHF',  'Hochfilzen',                       8100052 ],
	[ 'XAHO',  'Hochzirl',                         8100111 ],
	[ 'XBHO',  'Hoeilaart',                        8800528 ],
	[ 'XDHT',  'Hoeje Taastrup st',                8601031 ],
	[ 'XAHH',  'Hohenau',                          8100130 ],
	[ 'XAHS',  'Hohenems',                         8100121 ],
	...
	[ 'XAIB', 'Imsterberg',    8101000 ],
	[ 'XAIP', 'Imst-Pitztal',  8100062 ],
	...
	[ 'XAKB',  'Kindberg',              8100030 ],
	[ 'XAKG',  'Kirchberg in Tirol',    8100057 ],
	[ 'XAKL',  'Kirchbichl',            8100290 ],
	[ 'XAKIT', 'Kittsee',               8100373 ],
	[ 'XAKIH', 'Kitzbühel Hahnenkamm', 8101044 ],
	[ 'XAKI',  'Kitzbühel',            8100055 ],
	...
	[ 'XALEZ', 'Lenzing',    8101141 ],
	[ 'XALO',  'Leoben Hbf', 8100070 ],
	[ 'XALG',  'Leogang',    8100051 ],
	[ 'XBLB',  'Leopoldsburg',        8800080 ],
	[ 'XALM',  'Lermoos',             8100552 ],
	...
	[ 'XAMH',  'Mitterberghütten',          8101219 ],
	[ 'XAMV',  'Mitterdorf-Veitsch',         8101221 ],
	...
	[ 'XIMOZ', 'Monza',    8300063 ],
	[ 'XAMB',  'Moosbierbaum-Heiligeneich', 8100376 ],
	...
	[ 'XAMM',  'Mühldorf-Möllbrücke', 8100087 ],
	[ 'XBMU',  'Muizen',                 8800129 ],
	...
	[ 'XAPD',  'Parndorf',                            8101335 ],
	[ 'XAPT',  'Paternion-Feistritz',                 8100086 ],
	[ 'XAPA',  'Patsch',                              8101337 ],
	[ 'XFPU',  'Pau',                                 8700106 ],
	[ 'XIPVI', 'Pavia',                               8300049 ],
	[ 'XAPG',  'Peggau-Deutschfeistritz',             8100034 ],
	...
	[ 'XAREZ', 'Retz',        8100469 ],
	[ 'XART',  'Reutte in Tirol',              8100115 ],
	[ 'XARTS', 'Reutte in Tirol Schulzentrum', 8101912 ],
	...
	[ 'XASBA', 'Salzburg Aigen',     8101470 ],
	[ 'XASB',  'Salzburg Hbf',       8100002 ],
	[ 'XASBP', 'Salzburg Parsch',    8101481 ],
	[ 'XASSA', 'Salzburg Sam',       8102055 ],
	[ 'XASBS', 'Salzburg Süd',      8101917 ],
	...
	[ 'XASFU', 'Schaftenau',   8100483 ],
	[ 'XASH',  'Schärding',   8100024 ],
	[ 'XAA',   'Scharnitz',    8100088 ],
	...
	[ 'XASL',  'Schladming',           8100137 ],
	[ 'XASBL', 'Schönbichl in Tirol', 8100557 ],
	[ 'XASCH', 'Schönwies',           8101629 ],
	...
	[ 'XASW',  'Schwarzach-St.Veit', 8100044 ],
	[ 'XASC',  'Schwaz',             8100103 ],
	...
	[ 'XAS',   'Seefeld in Tirol',        8100113 ],
	[ 'XASK',  'Seekirchen am Wallersee', 8100426 ],
	...
	[ 'XTSP', 'Spicak',           5400218 ],
	[ 'XASS', 'Spielfeld-Straß', 8100082 ],
	[ 'XSSP', 'Spiez', 8507483, 7.680097974211321, 46.68639215769284 ],
	[ 'XASPP', 'Spital am Pyhrn',         8100306 ],
	[ 'XASP',  'Spittal-Millstättersee', 8100092 ],
	...
	[ 'XAST',  'Steinach in Tirol',           8100107 ],
	...
	[ 'XATA',  'Treibach-Althofen', 8100096 ],
	...
	[ 'XAUH', 'Ulmerfeld-Hausmening',     8101695 ],
	[ 'XAU',  'Ulrichsbrücke-Füssen',   8100558 ],
	[ 'XAUS', 'Unterberg-Stefansbrücke', 8101712 ],
	[ 'XSUT', 'Unterterzen', 8509416, 9.255007770549312, 47.1138559733854 ],
	[ 'XAUM', 'Unzmarkt',    8100074 ],
	...
	[ 'XAVB',  'Vöcklabruck',            8100507 ],
	[ 'XAVM',  'Vöcklamarkt',            8100508 ],
	[ 'XIVOG', 'Voghera',                 8300492 ],
	[ 'XDV',   'Vojens st',               8602887 ],
	[ 'XTV',   'Vojtanov',                5400188 ],
	[ 'XAVO',  'Volders-Baumkirchen',     8100337 ],
	[ 'XAVL',  'Völs',                   8101728 ],
	...
	[ 'XAWB',  'Wartberg im Mürztal', 8100383 ],
	...
	[ 'XAWE', 'Wels Hbf',    8100014 ],
	[ 'XAWEN', 'Wendling b.Haag',     8101785 ],
	[ 'XAWRF', 'Werfen',              8100539 ],
	[ 'XAWR',  'Wernstein',           8100544 ],
	[ 'XBWT',  'Wespelaar-Tildonk',   8800324 ],
	[ 'XAWD',  'Westendorf in Tirol', 8100058 ],
	[ 'XSWE', 'Wettingen', 8503505, 8.315986352799943, 47.45963679441273 ],
	[ 'XAWF',  'Wien Franz-Josefs-Bahnhof',     8100446 ],
	[ 'XAWIF', 'Flughafen Wien',                8100353 ],
	[ 'XAWIE', 'Wien Hbf',                      8103000 ],
	[ 'XAWIO', 'Wien Hbf (Autoreisezuganlage)', 8100004 ],
	[ 'XAWH',  'Wien Hütteldorf',              8100447 ],
	[ 'XAWG',  'Wien Meidling',                 8100514 ],
	[ 'XAWMI', 'Wien Mitte',                    8100449 ],
	[ 'XAWNP', 'Wien Praterstern',              8100349 ],
	[ 'XAWSG', 'Wien Simmering',                8101553 ],
	[ 'XAWW',  'Wien Westbahnhof',              8100003 ],
	[ 'XAWNS', 'Wiener Neustadt Hbf',           8100516 ],
	[ 'XAWP',  'Wien Penzing',                  8100450 ],
	[ 'XSWI', 'Wil SG',      8506206, 9.040983279214002, 47.46240923730234 ],
	[ 'XAWI', 'Wildon',      8101774 ],
	[ 'XLWW', 'Wilwerwiltz', 8271120 ],
	[ 'XFWI', 'Wilwisheim',  8702269 ],
	[ 'XAWIG', 'Windischgarsten',  8100517 ],
	...
	[ 'XAZ',   'Zell am See',            8100048 ],
	[ 'XAZZ',  'Zell am Ziller',         8100547 ],
	[ 'XAZW',  'Zeltweg',                8100518 ],
