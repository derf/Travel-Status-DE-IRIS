...
my @stations = (
	...
	[ 'XSA',   'Aarau',                                  8502113 ],
	[ 'XSABO', 'Aarburg-Oftringen',                      8502000 ],
	[ 'XFAH',  'Achiet',                                 8700583 ],
	[ 'XSAA',  'Affoltern am Albis',                     8502224 ],
	[ 'XFAG',  'Agde',                                   8700145 ],
	[ 'XSAL',  'Aigle',                                  8501400 ],
	...
	[ 'XSADF', 'Altdorf(CH)',                            8505113 ],
	[ 'XSAD',  'Altendorf(CH)',                          8503211 ],
	[ 'XAAL',  'Altenmarkt im Pongau',                   8100139 ],
	[ 'XSAT',  'Altnau',                                 8506125 ],
	[ 'XSAS',  'Altstätten SG',                         8506319 ],
	...
	[ 'XSANF', 'Andelfingen',                            8506047 ],
	[ 'XSAN',  'Andermatt',                              8505165 ],
	[ 'XAAD',  'Andorf',                                 8100211 ],
	...
	[ 'XSRA',  'Bad Ragaz',                              8509004 ],
	[ 'XASBW', 'Bad Schallerbach-Wallern',               8100021 ],
	[ 'XAVN',  'Bad Vigaun',                             8101718 ],
	[ 'XSZZ',  'Bad Zurzach',                            8503409 ],
	[ 'XSBA',  'Baden(CH)',                              8503504 ],
	[ 'XFBX',  'Baisieux',                               8700510 ],
	[ 'XSBAL', 'Balerna',                                8505306 ],
	...
	[ 'XSB',   'Basel SBB',                              8500010 ],
	[ 'XSBP',  'Basel Dreispitz',                        8500132 ],
	[ 'XSBJ',  'Basel St Johann',                        8500016 ],
	[ 'XSBD',  'Bassersdorf',                            8503307 ],
	...
	[ 'XSBRG', 'Berg(CH)',                               8506194 ],
	[ 'XNBZ',  'Bergen op Zoom',                         8400108 ],
	[ 'XFBER', 'Bergues(Coudek)',                        8700707 ],
	[ 'XSBN',  'Bergün/Bravuogn',                       8509197 ],
	[ 'XSBLG', 'Berlingen(CH)',                          8506135 ],
	[ 'XSBLS', 'Berlingen URh',                          8506159 ],
	[ 'XSBE',  'Bern',                                   8507000 ],
	...
	[ 'XSCR',  'Capolago-Riva S. Vitale',                8505304 ],
	...
	[ 'XSCO',  'Cornaux',                                8504223 ],
	[ 'XFCOS', 'Cosne',                                  8703161 ],
	[ 'XSCS',  'Cossonay-Penthalaz',                     8501115 ],
	...
	[ 'XSDA',  'Dachsen',                                8506049 ],
	[ 'XSDS',  'Dagmersellen',                           8502004 ],
	[ 'XSDN',  'Däniken',                               8502111 ],
	[ 'XSDD',  'Davos Dorf',                             8509072 ],
	[ 'XSDP',  'Davos Platz',                            8509073 ],
	[ 'XFDX',  'Dax',                                    8700043 ],
	...
	[ 'XSDH',  'Diessenhofen',                           8503428 ],
	[ 'XSDHS', 'Diessenhofen URh',                       8506152 ],
	[ 'XSD',   'Dietlikon',                              8503306 ],
	...
	[ 'XSDO',  'Dottikon-Dintikon',                      8502212 ],
	...
	[ 'XSEK',  'Effretikon',                             8503305 ],
	[ 'XSEG',  'Eglisau',                                8503402 ],
	[ 'XSEN',  'Egnach',                                 8506309 ],
	[ 'XAEZ',  'Ehrwald Zugspitzbahn',                   8100089 ],
	[ 'XNEI',  'Eindhoven',                              8400206 ],
	[ 'XSES',  'Einsiedeln',                             8503283 ],
	[ 'XFEL',  'Elne',                                   8701064 ],
	[ 'XAEL',  'Elsbethen',                              8100772 ],
	[ 'XSEB',  'Emmenbrücke',                           8502021 ],
	[ 'XBEN',  'Engis',                                  8800464 ],
	[ 'XAEN',  'Enns',                                   8100011 ],
	...
	[ 'XFEN',  'Epinal',                                 8700255 ],
	[ 'XSE',   'Erlen',                                  8506107 ],
	[ 'XSEM',  'Ermatingen',                             8506133 ],
	[ 'XSEMS', 'Ermatingen URh',                         8506162 ],
	[ 'XBEQ',  'Erquelinnes',                            8800023 ],
	[ 'XFES',  'Erstein',                                8700281 ],
	[ 'XSEF',  'Erstfeld',                               8505114 ],
	...
	[ 'XSFA',  'Frauenfeld',                             8506100 ],
	[ 'XDF',   'Fredericia st',                          8600623 ],
	[ 'XSFB',  'Freienbach SBB',                         8503210 ],
	[ 'XSFF',  'Frenkendorf-Füllinsdorf',               8500022 ],
	[ 'XSF',   'Fribourg/Freiburg',                      8504100 ],
	...
	[ 'XSHG',  'Horgen',                                 8503204 ],
	[ 'XSHB',  'Horn(Bodensee)',                         8506307 ],
	[ 'XSHBS', 'Horn(Bodensee), SF',                     8506111 ],
	...
	[ 'XSIO',  'Interlaken Ost',                         8507492 ],
	[ 'XSI',   'Interlaken West',                        8507493 ],
	...
	[ 'XSKH',  'Kehlhof',                                8506193 ],
	[ 'XMK',   'Kelebia',                                5500092 ],
	[ 'XMBL',  'Kelenföld',                             5500008 ],
	[ 'XAKM',  'Kematen in Tirol',                       8101038 ],
	[ 'XSKW',  'Kesswil',                                8506123 ],
	[ 'XNKE',  'Kesteren',                               8400359 ],
	[ 'XSKB',  'Kilchberg(CH)',                          8503200 ],
	[ 'XSKS',  'Killwangen-Spreitenbach',                8503506 ],
	...
	[ 'XSKRB', 'Kreuzlingen Bernrain',                   8506197 ],
	[ 'XSKR',  'Kreuzlingen',                            8506131 ],
	[ 'XSKL',  'Kreuzlingen Hafen',                      8506128 ],
	...
	[ 'XSKN',  'Küssnacht am Rigi',                     8505002 ],
	[ 'XRKU',  'Kutina',                                 7800034 ],
	[ 'XPKT',  'Kutno',                                  5100032 ],
	[ 'XYKU',  'Kuty',                                   5600081 ],
	...
	[ 'XSLMC', 'Lamone-Cadempino',                       8505219 ],
	[ 'XALE',  'Landeck-Zams',                           8100063 ],
	[ 'XBLD',  'Landen',                                 8800079 ],
	[ 'XNLG',  'Landgraaf',                              8400548 ],
	[ 'XSLQ',  'Landquart',                              8509002 ],
	[ 'XFLA',  'Landry',                                 8700444 ],
	[ 'XBLO',  'Langdorp',                               8800243 ],
	[ 'XALA',  'Langen am Arlberg',                      8100065 ],
	[ 'XSLT',  'Langenthal(CH)',                         8508100 ],
	[ 'XALK',  'Langkampfen',                            8100300 ],
	[ 'XSLL',  'Läufelfingen',                          8500035 ],
	[ 'XSLF',  'Laufen(CH)',                             8500113 ],
	[ 'XSLN',  'Laufenburg(CH)',                         8500322 ],
	[ 'XSLA',  'Lausanne',                               8501120 ],
	[ 'XSLAF', 'Lausanne-Flon',                          8501181 ],
	[ 'XSLS',  'Lausen(CH)',                             8500024 ],
	...
	[ 'XALND', 'Lend',                                   8100045 ],
	[ 'XSLW',  'Lengwil',                                8506196 ],
	[ 'XFLN',  'Lens(F)',                                8700244 ],
	[ 'XSLB',  'Lenzburg',                               8502119 ],
	...
	[ 'XSLZ',  'Luterbach-Attisholz',                    8500208 ],
	...
	[ 'XSMM',  'Mammern(Bodensee)',                      8506137 ],
	[ 'XSMMS', 'Mammern URh',                            8506155 ],
	[ 'XBMA',  'Manage',                                 8800121 ],
	[ 'XSMB',  'Mannenbach-Salenstein',                  8506134 ],
	[ 'XSMBS', 'Mannenbach URh',                         8506160 ],
	...
	[ 'XUM',   'Medias',                                 5300063 ],
	[ 'XSM',   'Meiringen',                              8508308 ],
	[ 'XAME',  'Melk',                                   8100005 ],
	[ 'XSMS',  'Mels',                                   8509412 ],
	[ 'XFMEL', 'Melun',                                  8700540 ],
	[ 'XSME',  'Mendrisio',                              8505305 ],
	[ 'XFME',  'Menton',                                 8700150 ],
	[ 'XSMEN', 'Menznau',                                8508297 ],
	...
	[ 'XSRZ',  'Ranzo-S. Abbondio',                      8505408 ],
	[ 'XARK',  'Rattenberg-Kramsach',                    8100465 ],
	[ 'XIREC', 'Re(I)',                                  8302806 ],
	[ 'XSRM',  'Rebstein-Marbach',                       8506318 ],
	[ 'XFRD',  'Réding(F)',                             8700452 ],
	[ 'XSRC',  'Reichenbach im Kandertal',               8507480 ],
	[ 'XSRE',  'Reichenburg',                            8503223 ],
	[ 'XFRS',  'Reims',                                  8700081 ],
	[ 'XARE',  'Reith b.Seefeld',                        8100112 ],
	[ 'XDRE',  'Rejsby st',                              8601964 ],
	[ 'XARWL', 'Rekawinkel',                             8101432 ],
	[ 'XSRN',  'Rekingen AG',                            8503408 ],
	...
	[ 'XSRH',  'Rheineck',                               8506313 ],
	[ 'XSRD',  'Rheinfelden(CH)',                        8500301 ],
	[ 'XDRB',  'Ribe st',                                8601971 ],
	[ 'XDRBN', 'Ribe Noerremark st',                     8601972 ],
	[ 'XSRW',  'Richterswil',                            8503207 ],
	...
	[ 'XSRO',  'Roggwil-Berg',                           8506394 ],
	[ 'XSRY',  'Roggwil-Wynau',                          8508101 ],
	[ 'XARH',  'Rohr-Bad Hall',                          8100167 ],
	[ 'XTRO',  'Rokycany',                               5400182 ],
	[ 'XIRM',  'Roma Termini',                           8300263 ],
	[ 'XSR',   'Romanshorn',                             8506121 ],
	[ 'XSRHF', 'Romanshorn (See)',                       8506112 ],
	[ 'XFRO',  'Rombas-Clouange',                        8700369 ],
	[ 'XBRO',  'Ronet',                                  8800155 ],
	[ 'XLRT',  'Roodt/Syre',                             8270890 ],
	[ 'XNRD',  'Roosendaal',                             8400526 ],
	[ 'XARP',  'Roppen',                                 8101448 ],
	[ 'XSRS',  'Rorschach',                              8506311 ],
	[ 'XSRSH', 'Rorschach Hafen',                        8506306 ],
	[ 'XSRSS', 'Rorschach Hafen (See)',                  8506113 ],
	[ 'XARB',  'Rosenbach bei Villach',                  8100083 ],
	[ 'XAXRB', 'Jesenice(Gr)',                           7900043 ],
	[ 'XDRK',  'Roskilde st',                            8602026 ],
	[ 'XTRV',  'Rotava',                                 5402682 ],
	[ 'XSRTB', 'Rothenburg(CH)',                         8502020 ],
	[ 'XSRTT', 'Rothenthurm(CH)',                        8503282 ],
	[ 'XSRR',  'Rothrist',                               8508103 ],
	[ 'XSRK',  'Rotkreuz',                               8502202 ],
	...
	[ 'XSRU',  'Rümlang',                               8503311 ],
	[ 'XSRP',  'Rupperswil',                             8502114 ],
	[ 'XSRL',  'Rüschlikon',                            8503201 ],
	[ 'XTRS',  'Rusova',                                 5402723 ],
	[ 'XSRT',  'Rüthi SG',                              8509401 ],
	...
	[ 'XSSD',  'Samedan',                                8509251 ],
	[ 'XSSMT', 'Samstagern',                             8503286 ],
	...
	[ 'XSSF',  'Schindellegi-Feusisberg',                8503285 ],
	...
	[ 'XSSG',  'St. Gallen(CH)',                         8506302 ],
	[ 'XSSGW', 'St. Gallen(CH) Winkeln',                 8506300 ],
	[ 'XSSGH', 'St. Gallen(CH) Haggen',                  8506392 ],
	[ 'XFJ',   'St-Jory(Toulouse)',                      8702033 ],
	[ 'XFSMA', 'St Malo',                                8700228 ],
	[ 'XAJO',  'St.Jodok am Brenner',                    8101529 ],
	[ 'XSMZ',  'St. Moritz',                             8509253 ],
	...
	[ 'XSTOA', 'Tobel-Affeltrangen',                     8506183 ],
	...
	[ 'XSWW',  'Wädenswil',                             8503206 ],
	[ 'XAWA',  'Wald am Schoberpass',                    8100127 ],
	[ 'XSWA',  'Walenstadt',                             8509414 ],
	[ 'XLWF',  'Walferdange',                            8271060 ],
	[ 'XSWS',  'Wallisellen',                            8503129 ],
	...
	[ 'XSZB',  'Ziegelbrücke',                          8503225 ],
	[ 'XPZIG', 'Zielona Gora Gl.',                       5100222 ],
	[ 'XAZL',  'Zirl',                                   8100451 ],
	[ 'XTFS',  'Zirovice-Seniky',                        5400962 ],
	[ 'XSZI',  'Zizers',                                 8509054 ],
	[ 'XSZG',  'Zofingen',                               8502001 ],
	[ 'XBZO',  'Zolder',                                 8800145 ],
	[ 'XSZU',  'Zug(CH)',                                8502204 ],
	[ 'XNZB',  'Zuidbroek',                              8400742 ],
	[ 'XEZM',  'Zumarraga',                              7100369 ],
	[ 'XSZN',  'Zürich Enge',                           8503010 ],
	[ 'XSZF',  'Zürich Flughafen',                      8503016 ],
	[ 'XSZH',  'Zürich HB',                             8503000 ],
	[ 'XSZW',  'Zürich Wiedikon',                       8503011 ],
	[ 'XSZWO', 'Zürich Wollishofen',                    8503009 ],
	[ 'XSZA',  'Zürich Altstetten',                     8503001 ],
	[ 'XSZR',  'Zürich Hardbrücke',                    8503020 ],
	[ 'XSZO',  'Zürich Oerlikon',                       8503006 ],
	[ 'XSZP',  'Opfikon',                                8503340 ],
	[ 'XSZS',  'Zürich Stadelhofen',                    8503003 ],
