...
my @stations = (
	...
	[ 'HBR A', 'Bremen Rbf Ausf' ],
	[ 'HBR E', 'Bremen Rbf Einf' ],
	[ 'HBRN',  'Bremen-Aumund' ],
	...
	[ 'FDSU',  'Dausenau' ],
	[ 'EDVB',  'Davensberg' ],
	[ 'XKDL',  'Daventry IRFT In' ],
	[ 'XKDW',  'Daventry IRFT Wa' ],
	[ 'XSDD',  'Davos Dorf' ],
	[ 'XSDP',  'Davos Platz' ],
	[ 'FWX',   'Da-Wixhausen' ],
	[ 'XFDX',  'Dax' ],
	...
	[ 'FEKB',  'Gi Erdk Bieber' ],
	[ 'FEKM',  'Gi Erdk MTG' ],
	[ 'FLST',  'Gi Licher Straße' ],
	[ 'XIGI',  'Giarole' ],
	[ 'XIGR',  'Giarre-Riposto' ],
	[ 'TGB',   'Giengen (Brenz)' ],
	[ 'FEKW',  'Gi-Erdkauterweg' ],
	[ 'LGI',   'Giersleben' ],
